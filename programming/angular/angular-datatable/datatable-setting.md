...
*   Table line-height<br>

    <pre class="language-scss" data-full-width="true"><code class="lang-scss">::ng-deep td {
...
*   Button position<br>
    ...
    <pre class="language-typescript" data-full-width="true"><code class="lang-typescript">dom:
    ...
    <pre class="language-scss" data-full-width="true"><code class="lang-scss">::ng-deep.dt-type-numeric.sorting_1{
...
*   ajax<br>
    ...
    <pre class="language-typescript" data-full-width="true"><code class="lang-typescript">  ajax: (dtParameters: any, callback: any) => {
        this.isLoading = true;
